...
<img src="https://dxyt-july-image.oss-cn-beijing.aliyuncs.com/CSDN/image-20220726090225310.png" alt="image-20220726090225310" style="zoom:80%;" />

并且，抽象类的子类也是无法实例化对象的：
<img src="https://dxyt-july-image.oss-cn-beijing.aliyuncs.com/CSDN/image-20220726090529370.png" alt="image-20220726090529370" style="zoom:80%;" />

> 继承了抽象类的类，也就**继承了抽象类的纯虚函数**，所以 抽象类的子类也**无法实例化对象**

但是，当 **子类重写了父类的纯虚函数时，子类就可以实例化对象** 了，并且可以多态调用：

<img src="https://dxyt-july-image.oss-cn-beijing.aliyuncs.com/CSDN/image-20220726091417278.png" alt="image-20220726091417278" style="zoom:80%;" />
...
<img src="https://dxyt-july-image.oss-cn-beijing.aliyuncs.com/CSDN/image-20220726093251924.png" alt="image-20220726093251924" style="zoom:80%;" />
...
>
> <img src="https://dxyt-july-image.oss-cn-beijing.aliyuncs.com/CSDN/image-20220726094050975.png" alt="image-20220726094050975" style="zoom:80%;" />
>
> 这段代码的输出结果是什么？
>
> <img src="https://dxyt-july-image.oss-cn-beijing.aliyuncs.com/CSDN/image-20220726094556986.png" alt="image-20220726094556986" style="zoom:80%;" />
>
> 答案是：**`B->1`** 
>
...
> >
> > <img src="https://dxyt-july-image.oss-cn-beijing.aliyuncs.com/CSDN/image-20220726095319606.png" alt="image-20220726095319606" style="zoom:80%;" />
> >
> > 进入 `test()` 函数时，**`this`指针是`A*`类型** 的，指向的是B类中A类的部分：<img src="https://dxyt-july-image.oss-cn-beijing.aliyuncs.com/CSDN/image-20220726095746978.png" alt="image-20220726095746978" style="zoom:80%;" />
> >
...
> >
> > 所以，在多态调用此函数时，其实是：<img src="https://dxyt-july-image.oss-cn-beijing.aliyuncs.com/CSDN/image-20220726101327948.png" alt="image-20220726101327948" style="zoom:80%;" />
> >
> > 而不是：<img src="https://dxyt-july-image.oss-cn-beijing.aliyuncs.com/CSDN/image-20220726101349534.png" alt="image-20220726101349534" style="zoom:80%;" />
> >
> > > C++ 这样设计真的离谱！！！
>
> 而 如果是正常的调用 B类的`func()` 而不通过多态调用，又会正常调用函数：
> <img src="https://dxyt-july-image.oss-cn-beijing.aliyuncs.com/CSDN/image-20220726101713007.png" alt="image-20220726101713007" style="zoom:80%;" />
>
