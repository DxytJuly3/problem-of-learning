...
>
>![image-20220302175910293](C:\Users\xyt15\AppData\Roaming\Typora\typora-user-images\image-20220302175910293.png)
>
>当我们不使用 `fseek` 函数时，
>
>```C
...
>```
>
>这段代码的运行结果是： <img src="C:\Users\xyt15\AppData\Roaming\Typora\typora-user-images\image-20220302180555337.png" alt="image-20220302180555337" style="zoom: 67%;" /> 此时，文件指针应该在 文件内容的 `k` 字符上。如果再使用 `ch = fgetc(pf)` ，并输出 `ch` 存入的字符，将输出 `k`。
>
...
>>
>> <img src="C:\Users\xyt15\AppData\Roaming\Typora\typora-user-images\image-20220302181822486.png" alt="image-20220302181822486" style="zoom:67%;" />
>>
>> 文件指针从当前位置向后偏移 10 个字符，到 `u` 
>
>> `fseek(pf, 15, SEEK_SET);`
>>
>> <img src="C:\Users\xyt15\AppData\Roaming\Typora\typora-user-images\image-20220302182100844.png" alt="image-20220302182100844" style="zoom:67%;" />
>>
>> 文件指针从文件内容的首位，想后偏移 15 个字符，到 `p`
>
>> `fseek(pf, -5, SEEK_END);`
>>
>> <img src="C:\Users\xyt15\AppData\Roaming\Typora\typora-user-images\image-20220302182653974.png" alt="image-20220302182653974" style="zoom:67%;" />
>>
...
>  上述代码的运行结果：
>
> <img src="C:\Users\xyt15\AppData\Roaming\Typora\typora-user-images\image-20220302204926852.png" alt="image-20220302204926852" style="zoom:67%;" />  
>
...
> 代码运行结果：
>
> <img src="C:\Users\xyt15\AppData\Roaming\Typora\typora-user-images\image-20220302205441476.png" alt="image-20220302205441476" style="zoom:67%;" />
